$(function () {
    ...
    var url = '/api/admin/stores/'+storeId+'/menu-sections/'+menuSectionId + '/menu-items/' + menuItemId + '/menu-option-groups/';
    ...
    var menuItemOptionGroupTable = $('table#menuItemOptionGroupTable').DataTable({
        ...
        ajax: '/api/admin/stores/' + storeId + '/menu-sections/' + menuSectionId + '/menu-items/'+ menuItemId + '/menu-option-groups/data-table',
        language: lang_kor,
        dom:
        ...
        columns: [
            ...
            },
            {
                data: 'id',
                render: function (data, type, row, meta) {
                    return '<a href="#" onclick="removeMenuOptionGroup(\'' +url + '\'' + ',' + row.id + '); return false;" class="btn btn-warning">해제</a>';
                }
            }
        ],
        buttons: [
    ...
    var menuOptionGroupTable = $('table#menuOptionGroupTable').DataTable({
        initComplete: function () {
        ...
        columns: [
            ...
            },
            {
                data: 'id',
                render: function (data, type, row, meta) {
                    return '<a href="#" onclick="addMenuOptionGroup(\'' +url + '\'' + ',' + row.id + '); return false;" class="btn btn-success">등록</a>';
                }
            }
        ],
        buttons: [
